...
* 🔒 [mrac-admittance-control-for-aerial-physical-interaction](https://github.com/IshaqHMK/mrac-admittance-control-for-aerial-physical-interaction): MATLAB/Simulink simulation and paper repository for MRAC-based adaptive admittance control of a fully actuated aerial robot during physical interaction with a flexible beam. `MATLAB`, `Simulink`, `UAV`, `Adaptive Control`, `Admittance Control`, `Physical Interaction`
